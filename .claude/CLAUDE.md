...
| Field | Value |
|---|---|
| Last completed slice | Slice 4 — Price Fetching (incl. corrected market-hours gates, TRY always-success, rate columns, skip messages; fetchers use symbol.code directly; BTC/ETH renamed to BTCUSDT/ETHUSDT) |
